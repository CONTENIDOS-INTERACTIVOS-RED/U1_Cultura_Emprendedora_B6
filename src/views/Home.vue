        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La cultura emprendedora es el conjunto de valores, actitudes y conocimientos que fomentan la innovación y la iniciativa para crear negocios o proyectos. Su origen se encuentra en la Revolución Industrial y ha evolucionado con la globalización y la digitalización. Las empresas, desde las tradicionales hasta las modernas, se han transformado mediante la tecnología y la sostenibilidad. El espíritu emprendedor impulsa la creatividad y el liderazgo, esenciales para identificar oportunidades y desarrollar ideas de negocio. La planificación estructurada es clave para convertir una idea en un emprendimiento viable y exitoso.
